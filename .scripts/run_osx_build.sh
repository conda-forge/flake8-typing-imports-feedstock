...
validate_recipe_outputs "flake8-typing-imports-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="flake8-typing-imports-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi